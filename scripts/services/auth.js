'use strict';
app.factory('Auth', function ($firebaseAuth, $firebaseArray, $firebaseObject) {
    ...
    var Auth = {
        ...
        createProfile: function (uid, user) {
            ...
            $firebaseArray(ref.child("profile").child(uid));
            var profileObj = $firebaseObject(ref.child("profile").child(uid));
        ...
        changePassword: function (user) {
            ...
            if (currUser.password = user.oldpass) {
                return currUser.$updatePassword(user.newpass);
            }
        },
